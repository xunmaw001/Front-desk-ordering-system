  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="订单号" prop="dingdanhao">
              <el-input v-model="ruleForm.dingdanhao" 
                placeholder="订单号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="配送分" prop="peisongfen">
          <el-select v-model="ruleForm.peisongfen" placeholder="请选择配送分">
            <el-option
                v-for="(item,index) in peisongfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="配送分" prop="peisongfen">
	      <el-input v-model="ruleForm.peisongfen"
                placeholder="配送分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="包装分" prop="baozhuangfen">
          <el-select v-model="ruleForm.baozhuangfen" placeholder="请选择包装分">
            <el-option
                v-for="(item,index) in baozhuangfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="包装分" prop="baozhuangfen">
	      <el-input v-model="ruleForm.baozhuangfen"
                placeholder="包装分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="菜品分" prop="caipinfen">
          <el-select v-model="ruleForm.caipinfen" placeholder="请选择菜品分">
            <el-option
                v-for="(item,index) in caipinfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="菜品分" prop="caipinfen">
	      <el-input v-model="ruleForm.caipinfen"
                placeholder="菜品分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.riqi" label="日期" prop="riqi">
              <el-input v-model="ruleForm.riqi" 
                placeholder="日期" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="建议" prop="jianyi">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jianyi" label="建议" prop="jianyi">
                    <span v-html="ruleForm.jianyi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dingdanhao = true;
            continue;
	            	            ...
	            	            if(o=='peisongfen'){
            this.ruleForm.peisongfen = obj[o];
	    this.ro.peisongfen = true;
            continue;
          }
	            	            if(o=='baozhuangfen'){
            this.ruleForm.baozhuangfen = obj[o];
	    this.ro.baozhuangfen = true;
            continue;
          }
	            	            if(o=='caipinfen'){
            this.ruleForm.caipinfen = obj[o];
	    this.ro.caipinfen = true;
            continue;
          }
	            	            if(o=='riqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.peisongfenOptions = "1分,2分,3分,4分,5分".split(',')
                                        this.baozhuangfenOptions = "1分,2分,3分,4分,5分".split(',')
                                        this.caipinfenOptions = "1分,2分,3分,4分,5分".split(',')
                                                                },
                                                                        // 多级联动参数
                                                                                            info(id) {
      this.$http({
        url: `meishipingfen/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `meishipingfen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.meishipingfenCrossAddOrUpdateFlag = false;
                  this.parent.search();
