...
public class DiscussmeishicaipinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussmeishicaipinEntity discussmeishicaipin, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussmeishicaipinEntity discussmeishicaipin, HttpServletRequest request){
        EntityWrapper<DiscussmeishicaipinEntity> ew = new EntityWrapper<DiscussmeishicaipinEntity>();
		PageUtils page = discussmeishicaipinService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussmeishicaipin), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody DiscussmeishicaipinEntity discussmeishicaipin, HttpServletRequest request){
    	discussmeishicaipin.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussmeishicaipinEntity> wrapper = new EntityWrapper<DiscussmeishicaipinEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussmeishicaipinService.selectCount(wrapper);
